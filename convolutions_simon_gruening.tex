...
&\leq \int_V ( (\frac{\delta}{2c})^p \frac{1}{c} ) \abs{k_e(y)} d\lambda(y)\\
&= ( (\frac{\delta}{2c})^p \frac{1}{c} ) \int_V  \abs{k_e(y)} d\lambda(y)\\
&\leq ( (\frac{\delta}{2c})^p \frac{1}{c} ) \int_G  \abs{k_e(y)} d\lambda(y)\\
&\leq ( (\frac{\delta}{2c})^p \frac{1}{c} ) c\\
&= ( (\frac{\delta}{2c})^p )\\
\end{align*}
...
\end{align*}
Were we have once again used Fubini *, the definition of our norm, ...*
